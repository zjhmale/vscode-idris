...
* Support a new auto-completion mode which will always include all words in the currently opened documentation [#43](https://github.com/zjhmale/vscode-idris/issues/43)
